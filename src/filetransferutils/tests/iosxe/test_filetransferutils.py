...
class test_filetransferutils(unittest.TestCase):
	...
	outputs = {}
	outputs['show version | redirect tftp://10.1.7.250//auto/tftp-ssr/test_file_name.py'] = raw1
	outputs['copy crashinfo:/corefile.core.gz tftp://10.1.7.250//auto/tftp-ssr/corefile.core.gz'] = raw1
	outputs['show clock | redirect tftp://10.1.7.250//auto/tftp-ssr/aDevice'] = raw1
	outputs['copy tftp://10.1.7.250//auto/tftp-ssr/new_file-2018-01-10-10_24_58 running-config'] = raw2
	...
	def test_basic_check(self):
		...
		self.tftpcls.basic_check(device=self.device, vrf=None,
