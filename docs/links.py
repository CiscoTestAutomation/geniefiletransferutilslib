...
internal_links = {'pyats': ('%s://wwwin-pyats.cisco.com', 'pyATS'),
                  ...
                  'multiprotocolutilities': ('%s://wwwin-pyats.cisco.com/documentation/html/utilities/file_transfer_utilities.html', 'Multiprotocol File Transfer'),
...
external_links = {'pyats': ('%ss://developer.cisco.com/site/pyats/', 'pyATS'),
                  ...
                  'multiprotocolutilities': ('%ss://pubhub.devnetcloud.com/media/pyats/docs/utilities/file_transfer_utilities.html', 'Multiprotocol File Transfer'),
